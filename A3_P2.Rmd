...
models2 <- c("Diagnosis ~ meanS + trial + RRs + (1|Study)",
            ...
            "Diagnosis ~ LAMs+mean+RRs+(1|Study)", 
...
#testing model
m1=glmer(Diagnosis ~ trial + meanS + LAMs + RRs + maxLs + ENTRs + DETs + rENTRs + nsyllS + TTs +(1|Study),df, family = "binomial",  control = glmerControl(calc.derivs = FALSE))
summary(m1)
